#!/bin/bash
export WANDB_PROJECT=ICL-CEIL  # change if needed
export WANDB_ENTITY=songw  # change to your wandb account
export WANDB_API_KEY=a3a0eec6fccf6b88defc855a87f52c8c523f39f5 # change to your api-key
